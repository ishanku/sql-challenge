...
-- Option 1 -- Extracting Current Managers Only
...
from dept_manager dm 
	...
	join employees e 
		on dm.emp_no = e.emp_no where extract(year from dm.to_date) > extract(year from CURRENT_DATE);
-- Option 2 -- Extracting All Managers Past and Current
select dm.dept_no as "Department Number" , d.dept_name as "Department Name",
	dm.emp_no as "Manager's Employee Number", e.last_name as "last name",
	e.first_name as "first name", dm.from_date  as "Start Date", dm.to_date as "End Date"
from dept_manager dm 
...
on de.emp_no = e.emp_no
join departments d
on de.dept_no =d.dept_no where de.to_date < current_date; 
